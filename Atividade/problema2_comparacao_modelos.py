...
# 9. Salvar em CSV
df_resultados.to_csv('resultados_modelos_classificacao_saude.csv', index=False)
print("\nResultados exportados para 'resultados_modelos_classificacao_saude.csv' com sucesso!")
...
plt.title('Comparação de Modelos - Acurácia vs F1-Score (Macro) no Teste - Saúde')
...
plt.savefig('grafico_comparacao_modelos_saude.png')
plt.show()
